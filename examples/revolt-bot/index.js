...
const SHAPES_API_KEY = process.env.SHAPES_API_KEY || 'wZ6TQ6SBziadFMVHjgnSKW_hpaH3uTt9Z87FG2AU8sY';
const SHAPES_USERNAME = process.env.SHAPES_USERNAME || 'eunchae3-0ppi';
